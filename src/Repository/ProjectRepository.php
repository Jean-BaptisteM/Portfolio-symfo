...
class ProjectRepository extends ServiceEntityRepository
{
    ...
    /**
     * Returns all projects whose category contains the value of $filterCategory
     * 
     * @return Project[] Returns an array of Project objects
     */
    public function filterAllProjectFilterByCategory($filterCategory)
    {
        return $this->createQueryBuilder('project')
            ->leftJoin('project.categories', 'category')
            ->andWhere('category.name LIKE :filterCategory')
